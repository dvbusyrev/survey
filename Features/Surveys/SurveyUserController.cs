...
public class SurveyUserController : Controller
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (Request.Headers["X-Requested-With"] == "XMLHttpRequest")
            {
                return PartialView("~/Views/Survey/Partials/_UserSurveyPageContent.cshtml", activeContentModel);
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return PartialView("~/Views/Survey/Partials/_UserSurveyFillContent.cshtml", model);
    }
