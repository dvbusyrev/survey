...
public sealed class ThemeSettings
{
    ...
    public int HeaderDarkenPercent { get; set; } = 16;
    public int FooterDarkenPercent { get; set; } = 16;
    public int ButtonDarkenPercent { get; set; } = 16;
    public int ButtonStrongDarkenPercent { get; set; } = 28;
    public int SurfaceTintOpacityPercent { get; set; } = 24;
}
