...
{
    public virtual async Task<AnswerSigningPayload> GetSigningDataAsync(
        int surveyId,
        int organizationId,
    ...
    public virtual async Task<bool> SaveSignatureAsync(
        int surveyId,
        int organizationId,
    ...
    public virtual async Task<bool> SaveDraftSignatureAsync(
        int surveyId,
        int organizationId,
        AnswerSignatureSaveRequest request,
        CancellationToken cancellationToken = default)
