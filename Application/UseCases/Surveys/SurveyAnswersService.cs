...
public sealed class SurveyAnswersService : ISurveyAnswersService
{
    ...
    public SurveyAnswersService(IAnswerReadRepository answerReadRepository)
    {
    ...
    {
        var survey = await _answerReadRepository.GetSurveyAsync(surveyId, cancellationToken);
        if (survey == null)
        {
            return null;
        }

        var answers = await _answerReadRepository.GetSurveyAnswersAsync(surveyId, cancellationToken);
