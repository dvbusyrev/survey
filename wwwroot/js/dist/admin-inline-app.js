(() => {
  ...
  // frontend/shims/react-globals.js
  var import_react, import_client, ReactDOM;
  ...
  // frontend/entries/admin-inline-app.js
  init_react_globals();

  // wwwroot/js/components/Header.js
  init_react_globals();
  window.Header = ({ userRole, displayName, userName, organizationName }) => {
    ...
    return import_react.default.createElement(
      ...
      import_react.default.createElement("img", { src: "/images/favicon.svg", alt: "Логотип", draggable: false }),
      import_react.default.createElement("h1", { className: "header-title" }, "Анкетирование"),
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("p", { className: "header-mode-label" }, headerTopLine),
          import_react.default.createElement("p", { id: "role", title: normalizedDisplayName }, normalizedDisplayName)
        ),
        import_react.default.createElement("button", { className: "logout-button", onClick: () => {
  ...
  window.Footer = () => {
    return import_react.default.createElement(
      "footer",
      null,
      import_react.default.createElement("p", null, "2026 Анкетирование. Все права защищены.")
    );
  };

  // wwwroot/js/pages/admin-inline-app-pages.jsx
  init_react_globals();
  (() => {
    ...
    adminInlineAppPages.ExtensionModal = function ExtensionModal({ survey, onClose }) {
      const [organizations, setOrganizations] = import_react.default.useState([]);
      const [loading, setLoading] = import_react.default.useState(true);
      const [error, setError] = import_react.default.useState("");
      const [extensions, setExtensions] = import_react.default.useState([{ organizationId: "", extendedUntil: "" }]);
      ...
      import_react.default.useEffect(() => {
        ...
        async function fetchOrganizations() {
          try {
            ...
            const normalizedOrganizations = Array.isArray(data) ? data.filter((org) => org && (org.organization_id !== void 0 || org.id !== void 0)).map((org) => ({
      ...
      const removeExtensionRow = (index) => {
        setExtensions((previous) => previous.length > 1 ? previous.filter((_, itemIndex) => itemIndex !== index) : previous);
      };
      ...
      return /* @__PURE__ */ import_react.default.createElement("div", { style: { maxWidth: "800px", margin: "0 auto", padding: "20px" } }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "h2_modal", style: { marginTop: 0, marginBottom: "16px", fontSize: "24px" } }, "Продление анкеты"), /* @__PURE__ */ import_react.default.createElement("p", { style: { marginBottom: "24px", color: "#555" } }, 'Анкета: "', survey?.name_survey, '"'), error && /* @__PURE__ */ import_react.default.createElement("div", { className: "error-message", style: { display: "block", marginBottom: "16px" } }, error), !loading && organizations.length > 0 && /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { style: { marginBottom: "20px" } }, extensions.map((extension, index) => /* @__PURE__ */ import_react.default.createElement(
        "div",
        {
          key: index,
          style: {
        ...
        /* @__PURE__ */ import_react.default.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ import_react.default.createElement("label", null, "Организация:"), /* @__PURE__ */ import_react.default.createElement(
          "select",
          {
          ...
          /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "-- Выберите организацию --"),
        ...
        /* @__PURE__ */ import_react.default.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ import_react.default.createElement("label", null, "Дата окончания:"), /* @__PURE__ */ import_react.default.createElement(
          "input",
          {
            type: "date",
        ...
        extensions.length > 1 && /* @__PURE__ */ import_react.default.createElement(
          "button",
          {
            type: "button",
      ...
      ))), /* @__PURE__ */ import_react.default.createElement("button", { type: "button", onClick: addExtensionRow }, "+ Добавить организацию"), /* @__PURE__ */ import_react.default.createElement("br", null)), !loading && !error && organizations.length === 0 && /* @__PURE__ */ import_react.default.createElement("p", null, "Доступных организаций для продления не найдено."), /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: "12px" } }, /* @__PURE__ */ import_react.default.createElement(
        "button",
        {
          type: "button",
    ...
    adminInlineAppPages.StatisticsPage = function StatisticsPage() {
      const [chartsData, setChartsData] = import_react.default.useState(null);
      const [loading, setLoading] = import_react.default.useState(true);
      const [error, setError] = import_react.default.useState("");
      const lineChartRef = import_react.default.useRef(null);
      const barChartRef = import_react.default.useRef(null);
      const pieChartRef = import_react.default.useRef(null);
      const radarChartRef = import_react.default.useRef(null);
      const chartInstances = import_react.default.useRef({
        line: null,
        bar: null,
        pie: null,
        radar: null
      ...
      if (loading) {
        return /* @__PURE__ */ import_react.default.createElement("div", { className: "loading" }, "Загрузка данных...");
      }
      if (error) {
        return /* @__PURE__ */ import_react.default.createElement("div", { className: "error" }, "Ошибка: ", error);
      }
      return /* @__PURE__ */ import_react.default.createElement("div", { style: { maxWidth: "1200px", margin: "0 auto", padding: "20px" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "note" }, /* @__PURE__ */ import_react.default.createElement("h2", null, "Статистика")), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-grid" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-container" }, /* @__PURE__ */ import_react.default.createElement("h3", { className: "chart-title" }, "Ответы по месяцам"), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-wrapper" }, /* @__PURE__ */ import_react.default.createElement("canvas", { ref: lineChartRef }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-container" }, /* @__PURE__ */ import_react.default.createElement("h3", { className: "chart-title" }, "Ответы по годам"), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-wrapper" }, /* @__PURE__ */ import_react.default.createElement("canvas", { ref: barChartRef }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-container" }, /* @__PURE__ */ import_react.default.createElement("h3", { className: "chart-title" }, "Распределение по типам анкет"), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-wrapper" }, /* @__PURE__ */ import_react.default.createElement("canvas", { ref: pieChartRef }))), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-container" }, /* @__PURE__ */ import_react.default.createElement("h3", { className: "chart-title" }, "Средний балл организаций по годам"), /* @__PURE__ */ import_react.default.createElement("div", { className: "chart-wrapper" }, /* @__PURE__ */ import_react.default.createElement("canvas", { ref: radarChartRef })))));
    };
  })();

  // wwwroot/js/pages/admin-inline-app-core.js
  init_react_globals();
  (() => {
    ...
    function renderContentWrapper(content) {
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "content-wrapper" }, content);
    }
    ...
    function getOrganizationOptions(surveys) {
      return Array.from(new Set(
        surveys.flatMap(
          (survey) => survey.organization_name ? survey.organization_name.split(",").map((name) => name.trim()) : []
        ).filter(Boolean)
      ));
    }
    function App() {
      ...
      const [monthFilter, setMonthFilter] = import_react.default.useState("");
      const [organizationFilter, setOrganizationFilter] = import_react.default.useState("");
      const [currentPage, setCurrentPage] = import_react.default.useState(1);
      const [modal, setModal] = import_react.default.useState(createClosedModalState);
      const [searchTerm, setSearchTerm] = import_react.default.useState("");
      const [surveys, setSurveys] = import_react.default.useState(() => Array.isArray(initialData.surveys) ? initialData.surveys : []);
      ...
      const filterSurveys = (surveyItems) => {
        return surveyItems.filter((survey) => {
          ...
          const matchesSearch = searchValue === "" || nameSurvey.includes(searchValue) || organizationName.includes(searchValue);
          const matchesMonth = monthFilter === "" || (new Date(survey.date_open).getMonth() + 1).toString() === monthFilter;
          const matchesOrganization = organizationFilter === "" || String(survey.organization_name || "").split(",").some((name) => name.trim().toLowerCase() === organizationFilter.toLowerCase());
      ...
      const renderMenuAndFilters = () => /* @__PURE__ */ import_react.default.createElement("div", { className: "menu-bar" }, /* @__PURE__ */ import_react.default.createElement(
        "div",
        {
      ...
      const renderSurveys = () => {
        ...
        return /* @__PURE__ */ import_react.default.createElement("div", { className: "content surveys-page", id: "default_content", "data-page": "surveys-list" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "note" }, /* @__PURE__ */ import_react.default.createElement("h2", null, "Список существующих анкет"), /* @__PURE__ */ import_react.default.createElement("p", null, "На данной странице представлен перечень анкет. В таблице вы можете редактировать, удалять, формировать отчёты, проверять подписи и копировать анкеты.")), /* @__PURE__ */ import_react.default.createElement("div", { className: "filter-sort" }, /* @__PURE__ */ import_react.default.createElement("button", { id: "add_survey_btn", onClick: () => openTabRef.current?.("add_survey") }, "Добавить анкету"), /* @__PURE__ */ import_react.default.createElement(
          "input",
          {
            type: "text",
            placeholder: "Поиск...",
          ...
          /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Все месяцы"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "1" }, "Январь"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "2" }, "Февраль"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "3" }, "Март"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "4" }, "Апрель"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "5" }, "Май"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "6" }, "Июнь"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "7" }, "Июль"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "8" }, "Август"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "9" }, "Сентябрь"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "10" }, "Октябрь"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "11" }, "Ноябрь"),
          /* @__PURE__ */ import_react.default.createElement("option", { value: "12" }, "Декабрь")
        ), /* @__PURE__ */ import_react.default.createElement(
          "select",
          {
          ...
          /* @__PURE__ */ import_react.default.createElement("option", { value: "" }, "Все организации"),
          organizationOptions.map((organization, index) => /* @__PURE__ */ import_react.default.createElement("option", { key: index, value: organization }, organization))
        )), /* @__PURE__ */ import_react.default.createElement("table", { id: "data_table", className: "surveys-table" }, /* @__PURE__ */ import_react.default.createElement("thead", null, /* @__PURE__ */ import_react.default.createElement("tr", { className: "table_tr" }, /* @__PURE__ */ import_react.default.createElement("th", { className: "table-th--start" }, "Название анкеты"), /* @__PURE__ */ import_react.default.createElement("th", null, "Месяц"), /* @__PURE__ */ import_react.default.createElement("th", null, "Организация"), /* @__PURE__ */ import_react.default.createElement("th", { className: "table-th--end th-centered" }, "Действия"))), /* @__PURE__ */ import_react.default.createElement("tbody", null, totalRecords === 0 ? /* @__PURE__ */ import_react.default.createElement("tr", { className: "no-results-row" }, /* @__PURE__ */ import_react.default.createElement("td", { colSpan: "4" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "no-results-message" }, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-search" }), /* @__PURE__ */ import_react.default.createElement("span", null, "Анкеты не найдены")))) : currentRecords.map((survey) => /* @__PURE__ */ import_react.default.createElement("tr", { key: survey.id_survey }, /* @__PURE__ */ import_react.default.createElement("td", null, survey.name_survey), /* @__PURE__ */ import_react.default.createElement("td", null, getMonthName(survey.date_open)), /* @__PURE__ */ import_react.default.createElement("td", null, survey.organization_name ? survey.organization_name.split(",").map((name) => name.trim()).filter(Boolean).join(", ") : "Не указано"), /* @__PURE__ */ import_react.default.createElement("td", { className: "action-icons" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container", onClick: () => setModal({ isOpen: true, content: "report", data: survey }) }, /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-list-check" })), /* @__PURE__ */ import_react.default.createElement("span", { className: "icon-tooltip" }, "Сформировать отчёт")), /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container", onClick: () => openTabRef.current?.("get_survey_signatures", survey.id_survey) }, /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-check" })), /* @__PURE__ */ import_react.default.createElement("span", { className: "icon-tooltip" }, "Проверить подпись")), /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container", onClick: () => setModal({ isOpen: true, content: "extend", data: survey }) }, /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-hourglass-half" })), /* @__PURE__ */ import_react.default.createElement("span", { className: "icon-tooltip" }, "Продлить")), /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container", onClick: () => setModal({ isOpen: true, content: "copy", data: survey }) }, /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-clipboard-copy" })), /* @__PURE__ */ import_react.default.createElement("span", { className: "icon-tooltip" }, "Копировать")), /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container", onClick: () => setModal({ isOpen: true, content: "update", data: survey }) }, /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-pen-to-square" })), /* @__PURE__ */ import_react.default.createElement("span", { className: "icon-tooltip" }, "Редактировать")), /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container", onClick: () => setModal({ isOpen: true, content: "delete", data: survey }) }, /* @__PURE__ */ import_react.default.createElement("span", null, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-trash" })), /* @__PURE__ */ import_react.default.createElement("span", { className: "icon-tooltip" }, "Удалить"))))))), totalRecords > 0 && /* @__PURE__ */ import_react.default.createElement("div", { className: "pagination-container" }, currentPage > 1 && /* @__PURE__ */ import_react.default.createElement(
          "button",
          {
            className: "pagination-button prev",
            onClick: () => setCurrentPage((page) => page - 1)
          },
          /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-chevron-left" }),
          " Предыдущая"
        ), /* @__PURE__ */ import_react.default.createElement("div", { className: "page-info" }, "Страница ", Math.min(currentPage, totalPages), " из ", totalPages), currentPage < totalPages && /* @__PURE__ */ import_react.default.createElement(
          "button",
          {
          ...
          "Следующая ",
          /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-chevron-right" })
        )));
      };
      const setHtmlContent = (html) => {
        setContent(renderContentWrapper(/* @__PURE__ */ import_react.default.createElement("div", { dangerouslySetInnerHTML: { __html: extractRenderableHtml(html) } })));
      };
        ...
        try {
          switch (tab) {
            ...
            case "download_logs": {
              ...
              if (!response.ok) {
                throw new Error(
                  window.getResponseErrorMessage ? window.getResponseErrorMessage(response, "Ошибка выгрузки логов") : `Ошибка выгрузки логов: ${response.status}`
                );
              }
      ...
      const renderModalContent = () => {
        switch (modal.content) {
          case "extend":
            return typeof ExtensionModal === "function" ? /* @__PURE__ */ import_react.default.createElement(ExtensionModal, { survey: modal.data, onClose: closeModal }) : /* @__PURE__ */ import_react.default.createElement("div", null, "Модуль продления не загружен.");
          case "report":
            return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h2", { className: "modal-title" }, "Сформировать отчёт"), /* @__PURE__ */ import_react.default.createElement(
              "div",
              {
                style: {
                  display: "flex",
              ...
              /* @__PURE__ */ import_react.default.createElement("div", { className: "submenu2-container", style: { flex: 1 } }, /* @__PURE__ */ import_react.default.createElement("button", { style: { width: "100%" } }, "Отчёт за месяц"), /* @__PURE__ */ import_react.default.createElement("div", { className: "submenu2" }, /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => createMonthlyReport(modal.data?.id_survey) }, "По выбранной анкете"), /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => createMonthlySummaryReport() }, "По всем анкетам"))),
              /* @__PURE__ */ import_react.default.createElement("div", { className: "submenu2-container", style: { flex: 1 } }, /* @__PURE__ */ import_react.default.createElement("button", { style: { width: "100%" } }, "Отчёт за квартал"), /* @__PURE__ */ import_react.default.createElement("div", { className: "submenu2" }, /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => createQuarterlyReport(1) }, "1 квартал"), /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => createQuarterlyReport(2) }, "2 квартал"), /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => createQuarterlyReport(3) }, "3 квартал"), /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => createQuarterlyReport(4) }, "4 квартал")))
            ));
          case "copy":
            return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-header" }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "h2_modal" }, "Копирование анкеты")), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-body" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "modal-message" }, 'Вы уверены, что хотите создать копию анкеты "', modal.data?.name_survey, '"?')), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-primary", onClick: handleCopySurvey }, "Копировать"), /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-secondary", onClick: closeModal }, "Отмена")));
          case "update":
            return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-header" }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "h2_modal" }, "Редактирование анкеты")), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-body" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "modal-message" }, 'Вы переходите к редактированию анкеты "', modal.data?.name_survey, '".')), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-primary", onClick: handleUpdateSurvey }, "Продолжить"), /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-secondary", onClick: closeModal }, "Отмена")));
          case "delete":
            return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-header" }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "h2_modal" }, "Удаление анкеты")), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-body" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "modal-message" }, 'Вы уверены, что хотите удалить анкету "', modal.data?.name_survey, '"?')), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-primary", onClick: handleDeleteSurvey }, "Удалить"), /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-secondary", onClick: closeModal }, "Отмена")));
          case "message":
            return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-header" }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "h2_modal" }, modal.isSuccess ? "Успешно" : "Ошибка")), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-body" }, /* @__PURE__ */ import_react.default.createElement("div", { className: `modal-message ${modal.isSuccess ? "success-message" : "error-message"}` }, modal.message)), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ import_react.default.createElement("button", { className: "modal_btn modal_btn-primary", onClick: closeModal }, "OK")));
          default:
            return null;
        }
      };
      ...
      if (!hasAccess) {
        return /* @__PURE__ */ import_react.default.createElement("div", { className: "access-denied" }, /* @__PURE__ */ import_react.default.createElement("h2", null, "Доступ запрещён"), /* @__PURE__ */ import_react.default.createElement("p", null, "У вас нет прав для просмотра этой страницы."), /* @__PURE__ */ import_react.default.createElement("br", null), /* @__PURE__ */ import_react.default.createElement("a", { href: "/", className: "btn" }, "Вернуться на страницу авторизации"));
      }
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "page-container" }, /* @__PURE__ */ import_react.default.createElement(
        Header,
        {
      ...
      ), /* @__PURE__ */ import_react.default.createElement("div", { className: "admin-container" }, /* @__PURE__ */ import_react.default.createElement(
        Navigation,
        {
          openTab,
          activeTab,
      ...
      ), /* @__PURE__ */ import_react.default.createElement("div", { id: "content_admin" }, showLoader ? /* @__PURE__ */ import_react.default.createElement("div", { className: "loading-overlay" }, /* @__PURE__ */ import_react.default.createElement("div", null, "Загрузка...")) : /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, ADMIN_MENU_TABS.includes(activeTab) && renderMenuAndFilters(), content))), /* @__PURE__ */ import_react.default.createElement(Footer, null), /* @__PURE__ */ import_react.default.createElement("div", { className: `modal ${modal.isOpen ? "modal--visible" : ""}` }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "modal-close", onClick: closeModal }, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-xmark" })), renderModalContent())));
    }
    const rootElement = document.getElementById("root");
    if (rootElement && typeof import_react.default !== "undefined" && typeof ReactDOM !== "undefined") {
      const root = ReactDOM.createRoot(rootElement);
      root.render(/* @__PURE__ */ import_react.default.createElement(App, null));
    }
  })();

  // wwwroot/js/pages/admin-inline-app-crud-and-answers.js
  init_react_globals();
})();
