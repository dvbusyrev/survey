(() => {
  ...
  // wwwroot/js/features/survey/survey-filter-popover.js
  (function() {
  ...
  // wwwroot/js/features/survey/survey-filter-summary.js
  (function() {
  ...
  // wwwroot/js/features/survey/survey-date-filter.js
  (function() {
  ...
  // wwwroot/js/features/survey/survey-checkbox-filter.js
  (function() {
    ...
    function render(instance, config) {
      ...
      options.forEach((option) => {
        ...
        const optionIds = state.serverMode && Array.isArray(option.ids) && option.ids.length > 0 ? option.ids : [optionId];
        const optionName = state.serverMode ? option.name : option;
        const isSelected = state.serverMode ? optionIds.some((id) => state[config.selectedIdsKey].includes(id)) : state[config.selectedValuesKey].includes(optionName);
    ...
    function toggleIds(instance, config, rawIds, isSelected, callbacks) {
      const ids = (Array.isArray(rawIds) ? rawIds : String(rawIds || "").split(",")).map((rawId) => Number.parseInt(String(rawId || ""), 10)).filter((id, index, values) => Number.isInteger(id) && values.indexOf(id) === index);
      if (ids.length === 0) {
        return;
      }
      const serverFilters = callbacks?.serverFilters || window.SurveyServerFilterState;
  ...
  // wwwroot/js/features/survey/survey-row-filtering.js
  (function() {
  ...
  // wwwroot/js/features/survey/survey-admin-date-filter.js
  (function() {
  ...
  // wwwroot/js/features/survey/surveys-page.js
  (function() {
  ...
  // wwwroot/js/features/survey/user-survey-page-helpers.js
  ...
  // wwwroot/js/features/survey/user-survey-local-filters.js
  ...
  // wwwroot/js/features/survey/user-survey-row-tooltip.js
  ...
  // wwwroot/js/features/survey/user-survey-list.js
