(() => {
  ...
  */
  ...
  // wwwroot/js/features/answers/answer-statistics-page.js
  (function() {
    ...
    const yearGuideLinePlugin = {
      ...
      beforeDatasetsDraw: function(chart, _args, options) {
        ...
        const color2 = options?.color || "rgba(79, 70, 229, 0.25)";
        const lineWidth = options?.lineWidth || 2;
        chart.ctx.save();
        chart.ctx.strokeStyle = color2;
    ...
    function renderCharts(chartsData) {
      ...
      charts.line = new auto_default(document.getElementById("lineChart"), {
        type: "line",
        data: {
          labels: yearLabels,
          datasets: [{
      ...
      charts.bar = new auto_default(document.getElementById("barChart"), {
        type: "bar",
        data: {
      ...
      if (chartsData.avgScoreByOrganizationRadar) {
        charts.organization = new auto_default(document.getElementById("radarChart"), {
          type: "bar",
          data: {
    ...
    async function init() {
      ...
      try {
        ...
        showGlobalError(
          typeof window.normalizeClientErrorMessage === "function" ? window.normalizeClientErrorMessage(error instanceof Error ? error.message : "Не удалось загрузить статистику.") : error instanceof Error ? error.message : "Не удалось загрузить статистику."
        );
      }
    }
...
chart.js/dist/chart.js:
   ...
   *)
*/
//# sourceMappingURL=answer-statistics-page.js.map
