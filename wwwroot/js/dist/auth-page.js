(() => {
  ...
  // frontend/entries/auth-page.js
  init_react_globals();

  // wwwroot/js/pages/auth-page.jsx
  init_react_globals();
  (() => {
    ...
    const Modal = ({ isOpen, onClose, title, message }) => {
      ...
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-overlay", onClick: onClose }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-content", onClick: (event) => event.stopPropagation() }, /* @__PURE__ */ import_react.default.createElement("h2", { className: "modal-title" }, title), /* @__PURE__ */ import_react.default.createElement("p", { className: "modal-message" }, message), /* @__PURE__ */ import_react.default.createElement("button", { className: "modal-button", onClick: onClose }, "Закрыть")));
    };
    const EyeIcon = ({ visible }) => visible ? /* @__PURE__ */ import_react.default.createElement("svg", { viewBox: "0 0 24 24", "aria-hidden": "true" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M3 3l18 18" }), /* @__PURE__ */ import_react.default.createElement("path", { d: "M10.6 10.7a3 3 0 0 0 4 4" }), /* @__PURE__ */ import_react.default.createElement("path", { d: "M9.9 5.2A11 11 0 0 1 12 5c6.5 0 10 7 10 7a17.3 17.3 0 0 1-4.1 4.8" }), /* @__PURE__ */ import_react.default.createElement("path", { d: "M6.6 6.7A17.7 17.7 0 0 0 2 12s3.5 7 10 7a10.8 10.8 0 0 0 5.2-1.3" })) : /* @__PURE__ */ import_react.default.createElement("svg", { viewBox: "0 0 24 24", "aria-hidden": "true" }, /* @__PURE__ */ import_react.default.createElement("path", { d: "M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z" }), /* @__PURE__ */ import_react.default.createElement("circle", { cx: "12", cy: "12", r: "3" }));
    ...
    const LoginForm = () => {
      const [formData, setFormData] = import_react.default.useState({
        username: "",
        password: ""
      });
      const [showPassword, setShowPassword] = import_react.default.useState(false);
      const [isSubmitting, setIsSubmitting] = import_react.default.useState(false);
      const [modal, setModal] = import_react.default.useState({
        isOpen: false,
        title: "",
        message: ""
      });
      ...
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "content" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "inner-container" }, /* @__PURE__ */ import_react.default.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ import_react.default.createElement("h1", { className: "form-title" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "welcome-text" }, "АНКЕТИРОВАНИЕ")), /* @__PURE__ */ import_react.default.createElement("div", { className: "form-group" }, /* @__PURE__ */ import_react.default.createElement("label", { className: "form-label", htmlFor: "username" }, "Имя пользователя"), /* @__PURE__ */ import_react.default.createElement("div", { className: "input-container" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container" }, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-user" })), /* @__PURE__ */ import_react.default.createElement(
        "input",
        {
          type: "text",
      ...
      ))), /* @__PURE__ */ import_react.default.createElement("div", { className: "form-group" }, /* @__PURE__ */ import_react.default.createElement("label", { className: "form-label", htmlFor: "password" }, "Пароль"), /* @__PURE__ */ import_react.default.createElement("div", { className: "input-container has-toggle" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "icon-container" }, /* @__PURE__ */ import_react.default.createElement("i", { className: "fas fa-lock" })), /* @__PURE__ */ import_react.default.createElement(
        "input",
        {
          type: "text",
    ...
    root.render(/* @__PURE__ */ import_react.default.createElement(LoginForm, null));
  })();
})();
