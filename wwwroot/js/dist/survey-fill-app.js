(() => {
  ...
  // frontend/entries/survey-fill-app.js
  init_react_globals();
  ...
  // wwwroot/js/pages/survey-fill-standalone.jsx
  init_react_globals();
  var SurveyFillPage = ({ initialData }) => {
    ...
    const [isSubmitted, setIsSubmitted] = import_react.default.useState(false);
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "page-container" }, /* @__PURE__ */ import_react.default.createElement(
    ...
    ), /* @__PURE__ */ import_react.default.createElement("div", { className: "admin-container" }, /* @__PURE__ */ import_react.default.createElement(Navigation, { activeTab: "answers_tab", userRole: initialData.userRole, userId: initialData.userId }), /* @__PURE__ */ import_react.default.createElement("div", { id: "content_admin" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "survey-fill-container" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "note" }, /* @__PURE__ */ import_react.default.createElement("h2", null, "Заполнение анкеты"), /* @__PURE__ */ import_react.default.createElement("p", null, "Пожалуйста, оцените каждый вопрос по шкале от 1 до 5")), error && /* @__PURE__ */ import_react.default.createElement("div", { className: "error-message" }, /* @__PURE__ */ import_react.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ import_react.default.createElement("circle", { cx: "12", cy: "12", r: "10" }), /* @__PURE__ */ import_react.default.createElement("line", { x1: "12", y1: "8", x2: "12", y2: "12" }), /* @__PURE__ */ import_react.default.createElement("line", { x1: "12", y1: "16", x2: "12.01", y2: "16" })), error), initialData.questions.map((question, index) => {
      const questionId = question.id || question.Id || index;
      const questionText = question.text || question.Text || `Вопрос ${index + 1}`;
      const answer = answers[questionId] || {};
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "question-container", key: questionId }, /* @__PURE__ */ import_react.default.createElement("h3", null, questionText), /* @__PURE__ */ import_react.default.createElement("div", { className: "rating-buttons" }, [1, 2, 3, 4, 5].map((rating) => /* @__PURE__ */ import_react.default.createElement(
        "button",
        {
          key: rating,
        ...
        rating
      ))), answer.rating > 0 && answer.rating < 5 && /* @__PURE__ */ import_react.default.createElement("div", { className: "comment-container" }, /* @__PURE__ */ import_react.default.createElement("label", { className: "comment-label" }, "Ваш комментарий"), /* @__PURE__ */ import_react.default.createElement(
        "textarea",
        {
      ...
      loading ? /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("span", { className: "loading-spinner" }), "Отправка...") : "Отправить ответы"
    ))))), /* @__PURE__ */ import_react.default.createElement(Footer, null));
  };
  window.renderStandaloneSurveyFill = function(initialData) {
    const root = ReactDOM.createRoot(document.getElementById("root"));
    root.render(/* @__PURE__ */ import_react.default.createElement(SurveyFillPage, { initialData }));
  };
